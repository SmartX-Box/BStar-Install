...
ovs-vsctl add-port br2 MYREN
ovs-vsctl set Interface MYREN type=patch
ovs-vsctl set Interface MYREN options:peer=C_MYREN

# Add patch port in bridge brcap

ovs-vsctl add-br brcap 
ovs-vsctl add-port brcap C_MYREN
ovs-vsctl set Interface C_MYREN type=patch
